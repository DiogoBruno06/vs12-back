...
CREATE TABLE BAIRRO(
	...
	CONSTRAINT FK_ESTADO FOREIGN KEY(ID_CIDADE,ID_ESTADO) REFERENCES ESTADO(ID_CIDADE,ID_ESTADO)
);
...
VALUES(SEQ_ENDERECO.NEXTVAL, 4, 91, 'Rua 01', 93, 'ap 101', '583980301');

INSERT INTO VEM_SER.ENDERECO
(ID_ENDERECO, ID_BAIRRO, ID_CIDADE, LOGRADOURO, NUMERO, COMPLEMENTO, CEP)
VALUES(SEQ_ENDERECO.NEXTVAL, 5, 92, 'Rua 02', 91, 'ap 301', '590323200');

INSERT INTO VEM_SER.ENDERECO
(ID_ENDERECO, ID_BAIRRO, ID_CIDADE, LOGRADOURO, NUMERO, COMPLEMENTO, CEP)
VALUES(SEQ_ENDERECO.NEXTVAL, 5, 92, 'Avenida 02', 92, 'ap 401', '593323311');


INSERT INTO BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME)
VALUES (SEQ_BAIRRO.NEXTVAL, 91, 3000, 'Manaíra');


INSERT INTO VEM_SER.BAIRRO
(ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME)
VALUES(SEQ_BAIRRO.NEXTVAL, 92, 3001, 'Santa Cruz');
