...
CREATE TABLE BAIRRO(
	...
	CONSTRAINT FK_BAIRRO_CIDADE_ESTADO FOREIGN KEY(ID_CIDADE,ID_ESTADO) REFERENCES CIDADE(ID_CIDADE,ID_ESTADO)
);
...
INSERT INTO VEM_SER.BAIRRO
(ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME)
VALUES(SEQ_BAIRRO.NEXTVAL, 1, 1, 'La Union');

INSERT INTO VEM_SER.ENDERECO
(ID_ENDERECO, ID_BAIRRO, ID_CIDADE, LOGRADOURO, NUMERO, COMPLEMENTO, CEP)
VALUES(SEQ_ENDERECO.NEXTVAL, 1, 1, 'Rua 01', 93, 'ap 101', '58398-031');
...
INSERT INTO VEM_SER.ENDERECO
(ID_ENDERECO, ID_BAIRRO, ID_CIDADE, LOGRADOURO, NUMERO, COMPLEMENTO, CEP)
VALUES(SEQ_ENDERECO.NEXTVAL, 1, 1, 'Avenida 02', 92, 'ap 401', '59332-331');
